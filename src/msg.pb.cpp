...
const ::google::protobuf::Descriptor* Mesg_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  Mesg_reflection_ = NULL;
...
void protobuf_AssignDesc_msg_2eproto() {
  ...
  Mesg_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      Mesg_descriptor_,
      Mesg::default_instance_,
      Mesg_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Mesg, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Mesg, _unknown_fields_),
      -1,
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    Mesg_descriptor_, &Mesg::default_instance());
}

}  // namespace

void protobuf_ShutdownFile_msg_2eproto() {
  delete Mesg::default_instance_;
  delete Mesg_reflection_;
}
...
void protobuf_AddDesc_msg_2eproto() {
  ...
  Mesg::default_instance_->InitAsDefaultInstance();
...
void Mesg::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* Mesg::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return Mesg_descriptor_;
}

const Mesg& Mesg::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_msg_2eproto();
  return *default_instance_;
}

Mesg* Mesg::default_instance_ = NULL;
...
void Mesg::MergeFrom(const ::google::protobuf::Message& from) {
  GOOGLE_CHECK_NE(&from, this);
  const Mesg* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const Mesg*>(
      &from);
  if (source == NULL) {
...
void Mesg::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void Mesg::CopyFrom(const Mesg& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool Mesg::IsInitialized() const {
...
::google::protobuf::Metadata Mesg::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = Mesg_descriptor_;
  metadata.reflection = Mesg_reflection_;
  return metadata;
}
